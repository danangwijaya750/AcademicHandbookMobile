 ...
 */
class ExpertiseVH(override val containerView: View): RecyclerView.ViewHolder(containerView)
    , RvAdapter.Binder<ExpertiseModel.Result>, LayoutContainer {
    override fun bindData(data: ExpertiseModel.Result) {
        tv_title.text=data.expertises
